...
CREATE TABLE `ts_permissions` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL COMMENT '权限检查使用该字段',
  `display_name` varchar(100) COLLATE utf8_unicode_ci NOT NULL,
  `action_url` varchar(200) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'url',
...
CREATE TABLE `ts_roles` (
  ...
  `display_name` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '显示名称',
  `remark` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT '角色描述',
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  PRIMARY KEY (`id`),
...
CREATE TABLE `ts_users` (
  ...
  `status` enum('4','3','2','1') DEFAULT '1' COMMENT '用户状态（1正常，2禁言，3禁止访问、4删除）',
...
INSERT INTO `ts_users` VALUES (1,'trueinfo','justin.bj@msn.com','18500190250','$2y$10$Q4mmuxd8BIGmugVV9yELKeTMeRBK2fVNNJ296l.8U7YX3OQfG8P4y','','1','',NULL,'2014-12-22 09:11:32'),(2,'justin','goooder@gmail.com','13811109684','$2y$10$F3/JX6jDgwsX3gBY9Cfdz..5BTK9gUNwCQQIE4L35ZCDfm1gvw2/K','/uploads/201412/20141223095955_Tulips.jpg','2','1','2014-12-22 09:08:44','2014-12-23 10:00:44');
...
-- Dump completed on 2014-12-23 11:09:45
